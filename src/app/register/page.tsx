            ...
            <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#030014', color: '#fafafa', fontFamily: 'var(--font-family)', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{
                    ...
                    <button onClick={() => router.push('/login')} style={{
                        padding: '16px 48px', background: 'linear-gradient(135deg, #4f46e5, #9333ea)', color: '#ffffff',
                ...
                <div style={{
                    ...
                    <style jsx>{`
                        ...
                        .input-floating:focus {
                            border-color: #a855f7; background: rgba(0,0,0,0.6);
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                        <div>
                            <label style={{ display: 'block', fontSize: '13px', fontWeight: 600, color: form.name ? '#a855f7' : '#e2e8f0', marginBottom: '8px', transition: 'color 0.2s' }}>Full Name *</label>
                        ...
                        <div>
                            <label style={{ display: 'block', fontSize: '13px', fontWeight: 600, color: form.email ? '#a855f7' : '#e2e8f0', marginBottom: '8px', transition: 'color 0.2s' }}>Email Address *</label>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 1fr', gap: '16px' }}>
                            <div>
                                <label style={{ display: 'block', fontSize: '13px', fontWeight: 600, color: form.phone ? '#a855f7' : '#e2e8f0', marginBottom: '8px', transition: 'color 0.2s' }}>Phone</label>
                                <input value={form.phone} onChange={e => set('phone', e.target.value)} placeholder="Optional" className="input-floating" />
                            </div>
                            <div>
                                <label style={{ display: 'block', fontSize: '13px', fontWeight: 600, color: form.course ? '#a855f7' : '#e2e8f0', marginBottom: '8px', transition: 'color 0.2s' }}>Interested Curriculum</label>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                            <div>
                                <label style={{ display: 'block', fontSize: '13px', fontWeight: 600, color: form.password ? '#a855f7' : '#e2e8f0', marginBottom: '8px', transition: 'color 0.2s' }}>Password *</label>
                            ...
                            <div>
                                <label style={{ display: 'block', fontSize: '13px', fontWeight: 600, color: form.confirmPassword ? '#a855f7' : '#e2e8f0', marginBottom: '8px', transition: 'color 0.2s' }}>Confirm Password *</label>
                                <div style={{ position: 'relative' }}>
